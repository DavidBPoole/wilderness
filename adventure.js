// ************* Data Arrays commented out and moved to respective data files for code modularization *************
// const trails = [{
//     id: 1,
//     price: "$$",
//     latitude: 8.99214,
...
// Original code block, do not comment out ********
const wildlife = [{
    id: 1,
    price: "$$$$",
    latitude: 57.6055534,
...
// adventure.js - Main file for displaying the adventure information - code to pull modularized code from trails and rivers JS ********
// const { getTrailInfo } = require('./trails');
// const { getRiverInfo } = require('./rivers');

// console.log("Welcome to Adventure Explorer!");

// console.log("Trails Information:");
// console.log(getTrailInfo().join("\n"));

// console.log("\nRivers Information:");
// console.log(getRiverInfo().join("\n"));
...
console.log(trailsHeader);
console.log(getTrailInfo().join("\n"));

console.log(riversHeader);
console.log(getRiverInfo().join("\n"));

// ******************* Below is commented out to test modularized code output *****************
...
// ************* Below was originall commented out; do not uncomment when reversing modularization ***************
